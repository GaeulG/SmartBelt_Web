	...
	<script type="text/javascript">
		...
		function drawVisualization() { 
			var data = google.visualization.arrayToDataTable([
					...
					<?php
						for($i = -4; $i <= 0; $i++){
							echo "['".$duedt[0]."년 ".($duedt[1]+$i)."월' ";
							$total_count = 0;
							for($j = 0;$j<3;$j++){
									
								$sql = "SELECT COUNT(*) FROM WalkState WHERE casenum = '".$j."' AND id='".$id."' AND month='".($duedt[1]+$i)."'";
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"><a href="main_statistics_monthly.php?username=<?php echo $id?>">월 별</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
